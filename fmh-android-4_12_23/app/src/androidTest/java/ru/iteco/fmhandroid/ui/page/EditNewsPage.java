...
public class EditNewsPage {
    ...
    public static ViewInteraction titleCategory = onView(withId(R.id.news_item_category_text_auto_complete_text_view));
    public static ViewInteraction heading = onView(withId(R.id.news_item_title_text_input_edit_text));
    ...
    public static ViewInteraction descriptions = onView(withId(R.id.news_item_description_text_input_edit_text));
    ...
    //Окно вопроса
    public static ViewInteraction actionBar = onView(withId(R.id.action_bar_root));
