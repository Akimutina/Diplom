...
public class AddNewsPage {
    ...
    public static ViewInteraction category = onView(withId(R.id.textinput_placeholder));
    ...
    //Одинаковый ID у Категории и Описания
    //public static ViewInteraction descriptions = onView(withId(R.id.textinput_placeholder));
